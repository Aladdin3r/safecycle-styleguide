  ...
  return (
    <>
      ...
      <div id="types" class="p-4">
        ...
        <div>Being a map app, Safestyle would often be needed by the users to view information about an actual physical location, that users may visit themselves. Thus, we will attempt to make use of as many actual images of the area that they are investigating as possible.</div>
