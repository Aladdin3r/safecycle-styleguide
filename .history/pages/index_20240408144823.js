        ...
        <div class="row">
          <div className="col-sm-6">
            ...
            <div class="card-body">
              ...
              <img class="card-img-top" src="/fullcolourlogo.svg" alt="Card image cap"></img>
          ...
          <div class="card bg-primary text-white mb-3" className={styles.card}>
            ...
            <div class="card-body">
              ...
              <img class="card-img-top" src="/blackandwhite logo.svg" alt="Card image cap"></img>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            </div>
          </div>
        </div>
        <div class="row">
          <div className="col-sm-6">
            ...
            <div class="card-body">
              ...
              <img class="card-img-top" src="/greyscalelogo.svg" alt="Card image cap"></img>
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            </div>
            </div>
          </div>
