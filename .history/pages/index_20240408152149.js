            ...
            <div class="row">
                <div className="col-sm-4">
                  <div class="bg-primary card text-white mb-3" className={styles.card}>
                    <div class="card-body">
                      ...
                      <img class="card-img-top" src="/favicon1.svg" alt="Monochromatic logo"></img>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content. blah blah blah</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-sm-4">
                  ...
                  <div class="card-body">
                    ...
                    <img class="card-img-top" src="/favicon2.svg" alt="horizontal full colour logo"></img>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
                  </div>
              ...
              <div className="col-sm-4">
                ...
                <div class="card-body">
                  ...
                  <img class="card-img-top" src="/favicon3.svg" alt="stacked/vertical colour logo"></img>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
                </div>
              </div>
