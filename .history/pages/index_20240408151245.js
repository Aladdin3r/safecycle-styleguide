          ...
          <div class="card-group">
              ...
              <div class="row">
                ...
                <div className="col-sm-4">
                  ...
                  <div class="card-body">
                    ...
                    <img class="card-img-top" src="/horizontalfullcolour.svg" alt="ful colour logo"></img>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
                  </div>
              ...
              <div className="col-sm-4">
                ...
                <div class="card-body">
                  ...
                  <img class="card-img-top" src="/verticalfullcolour.svg" alt="stacked colour logo"></img>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
                </div>
              </div>
